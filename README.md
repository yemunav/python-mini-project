...
1. Clone this repository:
   ...
   ```
2. Open `File_Handling_app.ipynb` in Jupyter Notebook (via Anaconda Navigator).
3. Run every cell from top to bottom so all functions are defined.
4. Run the final cell containing the menu loop, and enter a number (1–11) when prompted.
...
**Yemuna V**
GitHub: [github.com/yemunav](https://github.com/yemunav)
